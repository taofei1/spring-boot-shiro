...
import com.neo.shiro.filter.CustomLogoutFilter;
import com.neo.shiro.realm.UserRealm;
import com.neo.shiro.session.OnlineSessionDAO;
import com.neo.shiro.session.OnlineSessionFactory;
import com.neo.shiro.web.filter.CaptchaValidateFilter;
import com.neo.shiro.web.filter.OnlineSessionFilter;
import com.neo.shiro.web.filter.SyncOnlineSessionFilter;
import com.neo.shiro.web.session.OnlineWebSessionManager;
import com.neo.shiro.web.session.SpringSessionValidationScheduler;
...
public class ShiroConfig {
    ...
    public OnlineSessionDAO sessionDAO() {
        ...
        sessionDAO.setSyncPeriod(syncPeriod);
        return sessionDAO;
    }
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(org.apache.shiro.mgt.SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/cloudFile/**", "anon");
        filterChainDefinitionMap.put("/fileimg/**", "anon");
        filterChainDefinitionMap.put("/jsTree/**", "anon");
