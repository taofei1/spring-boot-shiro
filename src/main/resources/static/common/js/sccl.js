...
$(function(){
	...
	//getSkinByCookie();
	var menu="";
    $.getJSON("/loadMenuTree",function (result) {
        if(result.code=="00"){
        	menu=result.data;
        	console.log(menu);
	...
	/*菜单json*/
	/**var menu = [{"id":"3","name":"商品管理","parentId":"0","url":"","icon":"&#xe604;","order":"1","isHeader":"0","childMenus":[
					...
					{"id":"6","name":"订单管理","parentId":"0","url":"","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
